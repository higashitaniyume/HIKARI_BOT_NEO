...
本仓库当前包含 Pixiv、Instagram/Facebook、YouTube、Telegram 贴纸、本地贴纸、本地语音、TTS、AI Agent、JMComic、osu! 和星露谷物语 Wiki 相关实现。X/Twitter、抖音、Bilibili、TikTok、小黑盒等其他平台解析由独立 AstrBot 插件并行部署，不在本仓库内实现。
