...
本仓库当前包含 Pixiv、抖音、Bilibili、TikTok、快手、微博、小红书、闲鱼、今日头条、小黑盒、Twitter/X、Instagram/Facebook、YouTube、媒体详情 Web、Telegram 贴纸、本地贴纸、本地语音、TTS、AI Agent、JMComic、osu!、Steam 热门热卖日报、AI 最新资讯日报、定时推送框架、星露谷物语 Wiki 和 Minecraft Wiki 相关实现。聚合媒体解析能力来自 vendored 的 `drdon1234/astrbot_plugin_media_parser`。
