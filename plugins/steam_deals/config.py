...
DEFAULT_STEAM_DEALS_CONFIG: dict[str, Any] = {
    ...
    "include_market_results": True,
    "market_filters": ["topsellers"],
    "market_pages": 1,
    "market_count_per_page": 50,
    "include_search_results": True,
    "search_pages": 2,
    "search_count_per_page": 50,
    "search_sort_by": ["Discount_DESC", "Reviews_DESC", "Released_DESC"],
    "search_category1": 998,
    "include_steamdb_free_promotions": True,
    "price_watch": {
        "enabled": True,
        "mark_first_seen_as_new": True,
        "max_entries": 5000,
    },
    "daily_filter": {
        "enabled": True,
