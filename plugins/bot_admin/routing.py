...
ROUTE_DEFS: list[RouteEntry] = [
    ...
    RouteEntry({"GET"}, "/api/aiagent-quota", "api_aiagent_quota", "_handle_aiagent_quota"),
    ...
    RouteEntry({"GET"}, "/api/guard-config", "api_guard_config_get", "_handle_guard_config_get"),
    ...
    RouteEntry({"POST"}, "/api/guard-config", "api_guard_config_save", "_handle_guard_config_save"),
