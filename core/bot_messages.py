...
DEFAULT_MESSAGES: dict[str, Any] = {
    ...
    "aiagent": {
        ...
        "quota_exhausted": "{who}{period} AI 配额已用完（{used}/{limit}），{resets} 恢复。发送「额度」可查看详情。",
        "quota_usage": "今日：已用 {daily_used} / {daily_limit} · 剩余 {daily_remaining}\n本小时：已用 {hourly_used} / {hourly_limit} · 剩余 {hourly_remaining}\n重置：每日 {daily_resets}，每小时 {hourly_resets}",
