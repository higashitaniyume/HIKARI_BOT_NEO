...
DEFAULT_MESSAGES: dict[str, Any] = {
    ...
    "sticker": {
        ...
        "pack_list_next_page": "发送「贴纸包列表 {page}」查看下一页",
        "pack_list_stats_hint": "发送「贴纸包统计」只看总数",
    ...
    "osu": {
        ...
        "beatmap_usage": "用法：osu谱面 <谱面ID|关键词>",
        "beatmap_not_found_title": "没有找到谱面",
        "missing_download_title": "缺少下载参数",
        "download_usage": "用法：osu下载 <谱面集ID|谱面链接|关键词>",
