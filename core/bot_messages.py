...
DEFAULT_MESSAGES: dict[str, Any] = {
    ...
    "common": {
        ...
        "stats_label_jmcomic_downloads": "JMComic 下载",
        "stats_label_music_genre_queries": "音乐流派查询",
        "stats_label_profile_likes_given": "资料卡点赞",
        "stats_session_messages": "  会话消息：{count} 条",
        "stats_category_media": "📹 媒体解析",
        "stats_category_sticker": "🎨 贴纸",
        "stats_category_query": "🔍 查询",
        "stats_category_interact": "💬 互动",
        "stats_global_header": "📊 全局统计信息：",
        "stats_global_sessions": "  活跃会话：{groups} 个群 + {private} 个私聊 = {total} 个",
        "stats_global_line": "  {label}: {count} 次",
        "stats_global_category_media": "📹 媒体解析合计",
        "stats_global_category_sticker": "🎨 贴纸合计",
        "stats_global_category_query": "🔍 查询合计",
        "stats_global_category_interact": "💬 互动合计",
        "stats_global_first_session": "🕐 最早使用：{date}",
    },
    "about": {
    ...
    "sticker": {
        ...
        "preview_empty": "暂无预览",
        "collect_permission_denied": "你没有权限使用收集命令，仅超级管理员或群管理可用。",
        "collect_no_target": "请 @ 要收集的群友，例如：收集 @小明 小明表情包",
        "collect_bot_not_allowed": "不能收集机器人的表情包。",
        "collect_added": "已开始收集 {name}（{user_id}）的表情包 → 贴纸包「{pack}」\n发送「贴纸包 列表」可查看新贴纸包。",
        "collect_remove_not_found": "没有找到正在收集的用户 {user_id}。",
        "collect_removed": "已停止收集 {name}（{user_id}）的表情包，已有内容保留在贴纸包中。",
        "collect_list_empty": "当前没有收集目标。",
        "collect_list_header": "定向收集目标：",
        "collect_list_row": "· {name}（{user_id}）→ {pack}：已收集 {count} 张，群 {groups}",
        "collect_groups_all": "全部群",
    },
    "tg_sticker": {
    ...
    "bot_help": {
        ...
        "category_line": "📂 {name}",
        "category_line_with_platforms": "📂 {name}（{platforms}）",
        "category_hint": "发送「帮助 分区名」查看分区详情",
        "category_detail_title": "📂 {name}",
    ...
    "terraria_wiki": {
        ...
        "image_caption": "{title} 主图",
        "usage": "用法：trwiki <关键词>",
        "not_found": "没有在泰拉瑞亚 Wiki 找到「{keyword}」。",
        "failed": "泰拉瑞亚 Wiki 查询失败：{error}",
    },
    "isaac_wiki": {
        "result": "标题：{title}\n简介：{summary}\nURL：{url}",
        "link": "{title}\n{url}",
        "detail": "标题：{title}\n\n{detail}",
        "image_caption": "{title} 主图",
        "usage": "用法：isaacwiki <关键词>",
        "not_found": "没有在以撒 Wiki 找到「{keyword}」。",
        "failed": "以撒 Wiki 查询失败：{error}",
    },
    "music_genre": {
        "detail": "📖 {title}\n\n{detail}",
        "usage": "用法：流派 <音乐流派名称>\n用「流派列表」查看所有分类，用「流派树 <分类>」查看层级结构。",
        "not_found": "没有找到「{keyword}」相关的音乐流派。试试「流派列表」查看所有分类。",
        "failed": "音乐流派查询失败：{error}",
        "multiple_results": "找到多个相关流派：",
        "chapter_list": "📂 电子音乐流派分类：",
        "chapter_not_found": "没有找到分类「{chapter}」。试试「流派列表」查看所有分类。",
        "tree_usage": "用法：流派树 <分类名称>\n例：流派树 House、流派树 Techno\n用「流派列表」查看所有分类。",
        "tree_header": "🌳 {chapter} 流派层级（共 {count} 个流派）",
        "rel_usage": "用法：流派关系 <流派名称>\n例：流派关系 House、流派关系 Trance",
    },
    "steam_deals": {
    ...
    "netease": {
        ...
        "format_hint": "（回复这条信息说 mp3 换 MP3 / 回复 flac 换 FLAC）",
        "pref_updated": "已改默认音质为 {quality}，正在重新发送～",
        "card_hint": "🎵 想下载这首歌？引用这条卡片并 @我 即可",
    ...
    "qqmusic": {
        "failed": "QQ 音乐解析失败：{reason}",
        "resolve_failed": "无法识别这个 QQ 音乐链接，可能链接有误或歌曲已下架。",
        "vip_required": "🎵 这首歌是 QQ 音乐 VIP / 付费曲目，当前账号没有下载权限。",
        "cookie_required": "🎵 这首歌需要登录 QQ 音乐才能下载。\n请把 Netscape 格式的 cookie 文件放到 {path}（格式与获取方式见 README）。",
        "size_exceeded": "这首歌的文件超过了大小限制，已跳过。",
        "info": "🎵 {name}\n歌手：{singer}\n专辑：{album}\n时长：{duration}\n音质：{quality}\n大小：{size}",
        "private_chat_only": "多链接发送仅支持私聊，请私聊机器人发送链接。",
        "card_hint": "🎵 想下载这首歌？引用这条卡片并 @我，或者直接 @我 发链接即可～",
    },
    "tts": {
        "usage": "用法：说话 <文本>",
    ...
    "aiagent": {
        ...
        "timeout": "AI Agent 响应超时了，稍后再试一次吧。",
        "network_error": "AI Agent 连不上服务器，请检查网络或代理配置。",
        "rate_limited": "AI Agent 被上游限流了，过一会儿再聊吧。",
        "upstream_error": "AI Agent 上游服务出错了，稍后再试吧。",
